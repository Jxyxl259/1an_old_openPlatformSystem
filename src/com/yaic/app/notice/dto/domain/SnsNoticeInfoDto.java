 ...
 * Since 2013 - 2016
 */
package com.yaic.app.notice.dto.domain;
...
@Table(name = "t_sns_notice_info")
public class SnsNoticeInfoDto implements Serializable {
    
    private static final long serialVersionUID = SnsNoticeInfoDto.class.getName().hashCode();
    ...
    /** 是否带参数名:0:是,1:否 */ 
    private java.lang.String isPair;
    ...
    /** 是否失败重试：0是,1否 */ 
    private java.lang.Integer retryPolicy;
    ...
    /**
     * 设置属性是否带参数名:0:是,1:否的值
     */ 
    public void setIsPair(java.lang.String isPair) {
        this.isPair = isPair;
    }

    /**
     * 获取属性是否带参数名:0:是,1:否的值
     */
    public java.lang.String getIsPair() {
        return isPair;
    }
     ...
     * 设置属性是否失败重试：0是,1否的值
     */ 
    public void setRetryPolicy(java.lang.Integer retryPolicy) {
     ...
     * 获取属性是否失败重试：0是,1否的值
     */ 
    public java.lang.Integer getRetryPolicy() {
        return this.retryPolicy;
    }
    
    /**
     * 设置属性处理状态:0未处理成功,1已处理成功的值
     */ 
