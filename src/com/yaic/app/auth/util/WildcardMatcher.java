package com.yaic.app.auth.util;
...
public class WildcardMatcher {
    ...
    public static void main(String[] args) {
        System.out.println(match("com.yafa.user", "com.yafa.*", true));
    }
    ...
    /**
     * Empty construct, since all the methods are static, you don't ha ve to make an object of this class, and thus I
     * hide the construtor in private.
     */
     ...
     *            The wildcard.
     * @param ignorecase
     *            If this param is true, all the comparison is made not casesensitive.
     * 
     * @return True, if they matches.
     */
    ...
    /**
     * Inner method to test whether two string equals, it is same as S tring.equals, except that it supports wildcard
     * "?"
     * 
     * @param a
     *            A string to compare
    ...
    /**
     * Find the match position of the two string, it is same as String .indexOf, except that it supports wildcard "?"
     * 
     * @param string
    ...
    /**
     * This is a inner method called by charEqualsIgnoreCase, which gi ves the type of the cha.
     * 
     * @param c
     *            The char to find type.
     * 
     * @return LOWERCASE--if the char is in lowercase. UPPERCASE--if the char is in uppercase. NOT_A_LETTER--if the char
     *         is not a letter.
     */
